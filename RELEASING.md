...
All public packages stay on `0.1.x` until the project explicitly adopts a new release line. Use patch changesets for every release during this period; `pnpm version:check` prevents accidental `0.2.0` or higher bumps.
