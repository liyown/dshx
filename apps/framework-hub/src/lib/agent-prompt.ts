...
3. Read the relevant current API chapters under https://dshx.io/en/docs. Treat Host, Client, API, Settings, Prompt and Slot as API Candidate; treat Conversation, Vite compatibility and programmatic Tooling as Experimental.
...
3. 读取 https://dshx.io/zh/docs 下与任务相关的最新 API 章节。Host、Client、API、Settings、Prompt 和 Slot 是 API Candidate；Conversation、Vite 兼容层和程序化 Tooling 仍是 Experimental。
