...
export const cliAndInspect = defineDocsChapter({
  ...
  copy: {
    en: {
      ...
      title: "Build configuration and Vite extensions",
      intro:
        "Use the bounded DSHX config to select Host and Client entries, attach ordinary Vite plugins, and emit loader-ready single-file artifacts.",
      description:
        "Config face rules, Vite compatibility, CSS and assets, Tailwind, declarations, commands, and programmatic builds.",
      sections: [
        {
          id: "configuration",
    ...
    zh: {
      ...
      title: "Build 配置与 Vite 扩展",
      intro:
        "使用受限 DSHX config 选择 Host/Client 入口、接入标准 Vite 插件，并输出 loader-ready 单文件产物。",
      description:
        "Config face 规则、Vite 兼容性、CSS/资源、Tailwind、declaration、命令与程序化构建。",
      sections: [
        {
          id: "configuration",
